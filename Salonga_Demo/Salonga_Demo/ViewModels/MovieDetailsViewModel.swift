...
class MovieDetailsViewModel: NSObject {
    ...
    internal init(movieID: String, shortDescription: String, genresString: String, releasedDate: String, topDetailsCellViewModel: MovieDetailsCellViewModel) {
    ...
    init(with movie: Movie) {
        topDetailsCellViewModel = MovieDetailsCellViewModel(title: movie.title, imageName: movie.imageName, rating: movie.ratings, onWatchList: movie.onWatchList, trailerURLString: movie.trailerURLString)
